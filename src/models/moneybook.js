...
class Moneybook extends Model{
  ...
  static associate(db){
    db.Moneybook.hasMany(db.MoneybookDetail, {foreignKey: "moneybook_id"});
    db.Moneybook.hasMany(db.Comment, {foreignKey: "moneybook_id"});
    db.Moneybook.belongsTo(db.User, {foreignKey: "user_id"});
  }
}
